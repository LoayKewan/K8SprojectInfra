        ...
        stage('Git push') {
            steps {
               withCredentials([usernamePassword(credentialsId: 'github', usernameVariable: 'GITHUB_USERNAME', passwordVariable: 'GITHUB_TOKEN')]) {
                 sh '''
                 git pull --rebase https://$GITHUB_TOKEN@github.com/LoayKewan/K8SprojectInfra.git main
                 git push https://$GITHUB_TOKEN@github.com/LoayKewan/K8SprojectInfra.git main
                 '''
               }
            }
        }
